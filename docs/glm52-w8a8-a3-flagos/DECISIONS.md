...
| D-069 | `A3-CP-A2-v024`合同允许严格受限network与校验过的source relay | Execution paused after run `20260824T025250Z` | 合同边界保留；latest immutable result见`results/A2-v024/20260824T025250Z.md`；当前不授权重试 | 用户批准新的A2任务 |
