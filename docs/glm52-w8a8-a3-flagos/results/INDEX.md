...
|---|---|---|---|---|---|---|---|
| A3-HOST-DIR-INIT | 20260824T030000Z | PASS | `project/glm52-w8a8-v024@a9435a34` / tree`e5e073ed` / no code change | [result](A3-HOST-DIR-INIT/20260824T030000Z.md) | `/data/tiankuan/zyg/evidence/A3-HOST-DIR-INIT/20260824T030000Z` | SYNCED via [254ee3f](https://github.com/yanceng305-collab/glm52-w8a8-a3-flagos-control/commit/254ee3f412c84f617b171b1747f70dbce77327cb) | PENDING |
