...
| D-064 | FlagTree与compiler/provider共享namespace时必须形成single coherent provider | Required runtime gate / refined by D-075 | CANN9.0.0 clean-room目标为FlagTree`0.6.1+ascend3.5`；最终不得存在FlagTree/triton-ascend混杂文件或双重ownership | D-075 task结果 |
